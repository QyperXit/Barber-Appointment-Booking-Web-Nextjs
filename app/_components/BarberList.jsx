...
const BarberList = ({ doctor }) => {
  ...
  return (
    ...
    //         <h2 className="text-2xl font-bold text-gray-800 sm:text-3xl dark:text-gray-200">
    ...
    //         >
    //           <div
    //             className="p-4 hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-200 md:p-5 rounded-xl dark:hs-tab-active:bg-slate-900 dark:hover:bg-gray-700 active"
    ...
    //                   height={24}
    //                   alt="scissors"
    //                   className="flex-shrink-0 mt-2 text-gray-800 size-6 md:size-7 hs-tab-active:text-blue-600 dark:hs-tab-active:text-blue-500 dark:text-gray-200"
    //                 />
    //               )}

    //               <span className="grow ms-6">
    //                 <span className="block text-lg font-semibold text-gray-400 hs-tab-active:text-blue-600 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
    //                   Coming Soon ....
    //                 </span>
    ...
    //           <div
    //             type="button"
    //             className="p-4 hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent text-start hover:bg-gray-200 md:p-5 rounded-xl dark:hs-tab-active:bg-slate-900 dark:hover:bg-gray-700"
    ...
    //               </svg> */}
    //               <span className="grow ms-6">
    //                 <span className="block text-lg font-semibold text-gray-800 hs-tab-active:text-blue-600 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
    //                   Micheal
    //                 </span>
    //                 <Link
    //                   href={`/details/${7}`}
    ...
    <div className="mx-auto mt-20 mb-10 md:max-w-4xl">
      <div className="grid grid-cols-1 gap-2 mx-auto sm:grid-cols-4 ">
