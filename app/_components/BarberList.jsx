...
const BarberList = ({ doctor }) => {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="md:max-w-2xl md:mx-auto mt-20 mb-10">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
        <div className="space-y-2">
          <img
            className="w-full sm:size-40 object-cover"
          ...
          />
          <img className="w-full sm:size-40 object-cover" src="/1barber.webp" />
          <img
            className="w-full sm:size-40 object-cover"
